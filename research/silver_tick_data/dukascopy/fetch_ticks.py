...
BASE = os.environ.get("DUKA_BASE", os.path.abspath(os.path.join(os.path.dirname(__file__), "..")))
RAW = os.path.join(BASE, "raw")
LOGS = os.path.join(BASE, "logs")
CHECKPOINT = os.path.join(LOGS, "checkpoint.jsonl")

SYMBOL = os.environ.get("DUKA_SYMBOL", "XAUUSD")
...
START_HOUR = dt.datetime(2025, 8, 20, 14, tzinfo=UTC)
END_HOUR = dt.datetime(2026, 8, 20, 13, tzinfo=UTC)
